      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="https://www.linkedin.com/in/tut-wonders-9a6839378/">LinkedIn</a></li>
              <li><a href="https://www.facebook.com/tut.wonders">Facebook</a></li>
              <li><a href="https://www.instagram.com/tutwonders">Instagram</a></li>
            </ul>
          </div>
        </div>
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} Tut Wonders. {t('footer.rights')}</p>
          <p>Developed with ❤️ by Eyad Ashraf</p>
