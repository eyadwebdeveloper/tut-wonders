...
const WhyUs = () => {
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('.why-feature, .why-visual.reveal, .founder-card.reveal').forEach(el => {
      observer.observe(el);
    });
  ...
  return (
    <section id="why">
      <div className="container">
        ...
        <h2 className="section-title reveal">{t('why.title')}<br/>{t('why.titleEnd')}</h2>
        ...
        <div className="why-grid">
          <div className="why-visual reveal">
            <div className="why-card-main">
              ...
              <div style={{ marginTop: '16px', padding: '10px 14px', background: 'rgba(201,169,110,.06)', borderRadius: '6px', fontSize: '.75rem', color: 'var(--gold)', letterSpacing: '.1em', textAlign: 'center' }}>
          ...
          <div className="why-features">
            {features.map((feature, index) => (
              <div className="why-feature" key={index} style={{ transitionDelay: `${index * 0.1}s` }}>
                <div className="feature-icon">
                  {getIcon(feature.icon)}
                </div>
                <div>
                  <h3 className="feature-title">{t(`why.features.${feature.key}.title`)}</h3>
                  <p className="feature-desc">{t(`why.features.${feature.key}.desc`)}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="founder-card reveal" style={{ marginTop: '80px' }}>
          <div className="founder-quote-mark">
            <svg viewBox="0 0 48 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="founder-inner">
            <div className="founder-content">
              ...
              <div className="founder-sig">
                ...
                <div>
                  <strong className="founder-name">{t('why.founder.name')}</strong>
                  <span className="founder-title-role">{t('why.founder.title')}</span>
                </div>
              </div>
            </div>
          </div>
